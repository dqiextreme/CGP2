...
namespace CGP2.Controllers
{
    ...
    {
        T3WEB_2012Entities _oModelos = new T3WEB_2012Entities();
        private readonly T3WEB_2012Entities _oModelos2 = new T3WEB_2012Entities();

        public static string _Str_Vendedor = "S042_58";
        public static string _Str_Ccomp = "S042";
        public static string _Str_Grcomp = "4";
        public static string _Str_Zona_Usr = "C-01";
        ...
        public void IndexDetalle(Pedido model)
        {
            ...
            var strGroupCompUsuaro = _Str_Grcomp; // Convert.ToString(Session["strGroupCompUsuaro"]);
            var strCompUsuaro = _Str_Ccomp; // Session["strCompUsuaro"].ToString();
            var strZonaUsuario = _Str_Zona_Usr; // Session["strZonaUsuario"].ToString();
